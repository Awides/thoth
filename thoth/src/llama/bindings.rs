...
const _: () = {
    ["Size of ggml_backend_meta_split_state"]
        [::std::mem::size_of::<ggml_backend_meta_split_state>() - 2064usize];
    ...
    ["Offset of field: ggml_backend_meta_split_state::n_segments"]
        [::std::mem::offset_of!(ggml_backend_meta_split_state, n_segments) - 2056usize];
};
...
const _: () = {
    ...
    ["Offset of field: llama_model_params::use_direct_io"]
        [::std::mem::offset_of!(llama_model_params, use_direct_io) - 66usize];
    ["Offset of field: llama_model_params::use_mlock"]
        [::std::mem::offset_of!(llama_model_params, use_mlock) - 67usize];
    ["Offset of field: llama_model_params::check_tensors"]
        [::std::mem::offset_of!(llama_model_params, check_tensors) - 68usize];
    ["Offset of field: llama_model_params::use_extra_bufts"]
        [::std::mem::offset_of!(llama_model_params, use_extra_bufts) - 69usize];
    ["Offset of field: llama_model_params::no_host"]
        [::std::mem::offset_of!(llama_model_params, no_host) - 70usize];
    ["Offset of field: llama_model_params::no_alloc"]
        [::std::mem::offset_of!(llama_model_params, no_alloc) - 71usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of llama_context_params"][::std::mem::size_of::<llama_context_params>() - 136usize];
    ...
    ["Offset of field: llama_context_params::flash_attn_type"]
        [::std::mem::offset_of!(llama_context_params, flash_attn_type) - 36usize];
    ["Offset of field: llama_context_params::rope_freq_base"]
        [::std::mem::offset_of!(llama_context_params, rope_freq_base) - 40usize];
    ["Offset of field: llama_context_params::rope_freq_scale"]
        [::std::mem::offset_of!(llama_context_params, rope_freq_scale) - 44usize];
    ["Offset of field: llama_context_params::yarn_ext_factor"]
        [::std::mem::offset_of!(llama_context_params, yarn_ext_factor) - 48usize];
    ["Offset of field: llama_context_params::yarn_attn_factor"]
        [::std::mem::offset_of!(llama_context_params, yarn_attn_factor) - 52usize];
    ["Offset of field: llama_context_params::yarn_beta_fast"]
        [::std::mem::offset_of!(llama_context_params, yarn_beta_fast) - 56usize];
    ["Offset of field: llama_context_params::yarn_beta_slow"]
        [::std::mem::offset_of!(llama_context_params, yarn_beta_slow) - 60usize];
    ["Offset of field: llama_context_params::yarn_orig_ctx"]
        [::std::mem::offset_of!(llama_context_params, yarn_orig_ctx) - 64usize];
    ["Offset of field: llama_context_params::defrag_thold"]
        [::std::mem::offset_of!(llama_context_params, defrag_thold) - 68usize];
    ...
    ["Offset of field: llama_context_params::no_perf"]
        [::std::mem::offset_of!(llama_context_params, no_perf) - 114usize];
    ["Offset of field: llama_context_params::op_offload"]
        [::std::mem::offset_of!(llama_context_params, op_offload) - 115usize];
    ["Offset of field: llama_context_params::swa_full"]
        [::std::mem::offset_of!(llama_context_params, swa_full) - 116usize];
    ["Offset of field: llama_context_params::kv_unified"]
        [::std::mem::offset_of!(llama_context_params, kv_unified) - 117usize];
    ["Offset of field: llama_context_params::samplers"]
        [::std::mem::offset_of!(llama_context_params, samplers) - 120usize];
    ["Offset of field: llama_context_params::n_samplers"]
        [::std::mem::offset_of!(llama_context_params, n_samplers) - 128usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
